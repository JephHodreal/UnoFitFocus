...
<body>
    <main>
        <x-guest-layout>
            ...
            <div class="py-12 bg-cover bg-fixed bg-center" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url({{ asset('../assets/images/homehero.PNG') }});">
                <!-- About Section -->
                <div class="py-8">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-transparent text-white">
                            <div class="container mx-auto px-4 py-2">
                                <h2 class="text-4xl font-bold text-center pt-4 mb-10 text-white">{{ __('What We Do') }}</h2>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <div class="bg-white/10 p-6 rounded-lg text-center transition-all duration-300 hover:bg-white/20 hover:shadow-xl transform hover:scale-105">
                                        <div class="text-xl font-bold mb-2 text-white">{{ __('Real-time Posture Estimation') }}</div>
                                        <p class="text-sm text-gray-200">{{ __('Our FitCheck provides live posture estimation and feedback by determining if you are in the correct posture.') }}</p>
                                    </div>
                                    
                                    <div class="bg-white/10 p-6 rounded-lg text-center transition-all duration-300 hover:bg-white/20 hover:shadow-xl transform hover:scale-105">
                                        <div class="text-xl font-bold mb-2 text-white">{{ __('Personalized Workout Experience') }}</div>
                                        <p class="text-sm text-gray-200">{{ __('The difficulty of your workouts are adjusted based on your user profile to ensure you can meet your workout objectives.') }}</p>
                                    </div>
                                    
                                    <div class="bg-white/10 p-6 rounded-lg text-center transition-all duration-300 hover:bg-white/20 hover:shadow-xl transform hover:scale-105">
                                        <div class="text-xl font-bold mb-2 text-white">{{ __('Progress Tracking') }}</div>
                                        <p class="text-sm text-gray-200">{{ __('Our Dashboard provides an overview of your workouts to help you monitor your progress.') }}</p>
                                    </div>
                                    
                                    <div class="bg-white/10 p-6 rounded-lg text-center transition-all duration-300 hover:bg-white/20 hover:shadow-xl transform hover:scale-105">
                                        <div class="text-xl font-bold mb-2 text-white">{{ __('Workout Library') }}</div>
                                        <p class="text-sm text-gray-200">{{ __('We provide information about different exercises to assist you in your workouts.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
